...
#include <QtLottie/private/qtrimpath_p.h>
...
*/
QPainterPath QTrimPath::trimmed(qreal f1, qreal f2, qreal offset) const
{
    QPainterPath res;
...
void QTrimPath::updateLens() const
{
...
int QTrimPath::elementAtLength(qreal len) const
{
...
QPointF QTrimPath::endPointOfElement(int elemIdx) const
{
...
void QTrimPath::appendTrimmedElement(QPainterPath *to, int elemIdx, bool trimStart, qreal startLen, bool trimEnd, qreal endLen) const
{
    Q_ASSERT(elemIdx > 0);
...
void QTrimPath::appendElementRange(QPainterPath *to, int first, int last) const
{
